...
* [第3章 迭代器概念与traits编程技法](#第3章-迭代器概念与traits编程技法)
    * [3.3 迭代器相应类别](#33-迭代器相应类别)
    * [3.4 Traits编程技法](#34-traits编程技法)
    * [3.5 iterator 的保证](#35-iterator-的保证)
    * [3.7 SGI STL 的私房菜：__type_traits](#37-sgi-stl-的私房菜__type_traits)
* [第4章 序列式容器](#第4章-序列式容器)
    * [4.2 vector](#42-vector)
        * [4.2.1 vctor 概述](#421-vctor-概述)
        * [4.2.2 vector 定义摘要 ](#422-vector-定义摘要-)
        * [4.2.3 vector的迭代器](#423-vector的迭代器)
        * [4.2.4 vector的数据结构](#424-vector的数据结构)
        * [4.2.5 vector的构造](#425-vector的构造)
        * [4.2.6 vector的元素操作](#426-vector的元素操作)
    * [4.3 list](#43-list)
        * [4.3.1 list概述](#431-list概述)
        * [4.3.2 list的节点](#432-list的节点)
        * [4.3.3 list的迭代器](#433-list的迭代器)
        * [4.3.4 list的数据结构](#434-list的数据结构)
        * [4.3.5 list的构造](#435-list的构造)
        * [4.3.6 list的元素操作](#436-list的元素操作)
    * [4.4 deque](#44-deque)
        * [4.4.1 deque概述](#441-deque概述)
        * [4.4.2 deque的中控器](#442-deque的中控器)
        * [4.4.3 deque的迭代器](#443-deque的迭代器)
        * [4.4.4 deque的数据结构](#444-deque的数据结构)
        * [4.4.5 deque的构造](#445-deque的构造)
        * [4.4.6 deque的元素操作](#446-deque的元素操作)
    * [4.5 stack](#45-stack)
        * [4.5.1 stack概述](#451-stack概述)
        * [4.5.2 stack定义完整列表](#452-stack定义完整列表)
        * [4.5.3 stack没有迭代器](#453-stack没有迭代器)
        * [4.5.4 以list作为stack的底层容器](#454-以list作为stack的底层容器)
    * [4.6 queue](#46-queue)
        * [4.6.1 queue概述](#461-queue概述)
        * [4.6.2 queue定义完整列表](#462-queue定义完整列表)
        * [4.6.3 queue没有迭代器](#463-queue没有迭代器)
        * [4.6.4 以list作为queue的底层容器](#464-以list作为queue的底层容器)
    * [4.7 heap](#47-heap)
        * [4.7.1 heap概述](#471-heap概述)
        * [4.7.2 heap算法](#472-heap算法)
        * [4.7.3 heap没有迭代器](#473-heap没有迭代器)
    * [4.8 priority_queue](#48-priority_queue)
        * [4.8.1 priority_queue概述](#481-priority_queue概述)
        * [4.8.2 priority_queue定义完整列表](#482-priority_queue定义完整列表)
        * [4.8.3 priority_queue没有迭代器](#483-priority_queue没有迭代器)
    * [4.9 slist](#49-slist)
        * [4.9.1 slist概述](#491-slist概述)
        * [4.9.2 slist的节点](#492-slist的节点)
        * [4.9.3 slist的迭代器](#493-slist的迭代器)
        * [4.9.4 slist的数据结构](#494-slist的数据结构)
        * [4.9.5 slist的元素操作](#495-slist的元素操作)
* [第5章 关联式容器](#第5章-关联式容器)
    * [5.1 树的导览](#51-树的导览)
    * [5.2 RB-tree](#52-rb-tree)
        * [5.2.1 插入节点](#521-插入节点)
        * [5.2.2 一个由上而下的程序](#522-一个由上而下的程序)
        * [5.2.3 RB-tree的节点设计](#523-rb-tree的节点设计)
        * [5.2.4 RB-tree的迭代器](#524-rb-tree的迭代器)
        * [5.2.5 RB-tree的数据结构](#525-rb-tree的数据结构)
        * [5.2.6 RB-tree的构造](#526-rb-tree的构造)
        * [5.2.7 RB-tree的元素操作](#527-rb-tree的元素操作)
    * [5.3 set](#53-set)
    * [5.4 map](#54-map)
    * [5.5 multiset](#55-multiset)
    * [5.6 multimap](#56-multimap)
    * [5.7 hashtable](#57-hashtable)
        * [5.7.2 hashtable的桶（buckets）与节点（nodes）](#572-hashtable的桶buckets与节点nodes)
        * [5.7.3 hashtable的迭代器](#573-hashtable的迭代器)
        * [5.7.4 hashtable的数据结构](#574-hashtable的数据结构)
        * [5.7.5 hashtable的构造](#575-hashtable的构造)
        * [5.7.6 hashtable的元素操作](#576-hashtable的元素操作)
        * [5.7.7 hash function](#577-hash-function)
    * [5.8 hash_set](#58-hash_set)
    * [5.9 hash_map](#59-hash_map)
    * [5.10 hash_multiset](#510-hash_multiset)
    * [5.11 hash_multimap](#511-hash_multimap)
* [第6章 算法](#第6章-算法)
        * [6.1.5 STL算法的一般形式](#615-stl算法的一般形式)
    * [6.3 数值算法 <stl_numeric.h>](#63-数值算法-<stl_numerich>)
        * [6.3.2 accumulate](#632-accumulate)
    * [6.4 基本算法](#64-基本算法)
        * [6.4.1 equal()](#641-equal)
        * [6.4.2 fill()](#642-fill)
        * [6.4.3 fill_n()](#643-fill_n)
        * [6.4.4 iter_swap()](#644-iter_swap)
        * [6.4.5 max()](#645-max)
        * [6.4.6min()](#646min)
        * [6.4.7 swap()](#647-swap)
        * [6.4.8 copy()](#648-copy)
        * [6.4.9 copy_backward()](#649-copy_backward)
    * [6.5 Set相关算法](#65-set相关算法)
    * [6.7 其他算法](#67-其他算法)
        * [6.7.1 merge()](#671-merge)
        * [6.7.2 partition](#672-partition)
        * [6.7.3 remove()](#673-remove)
        * [6.7.4 remove_copy()](#674-remove_copy)
        * [6.7.5 replace()](#675-replace)
        * [6.7.6 reverse()](#676-reverse)
        * [6.7.7 search()](#677-search)
        * [6.7.8 sort()](#678-sort)
        * [6.7.9 for_each()](#679-for_each)
        * [6.7.10 lower_bound() 和 upper_bound()](#6710-lower_bound-和-upper_bound)
* [第7章 仿函数 函数对象](#第7章-仿函数-函数对象)
    * [7.1 仿函数概观](#71-仿函数概观)
    * [7.2 可配接的关键](#72-可配接的关键)
    * [7.6 证同、选择、投射](#76-证同选择投射)
* [第8章 配接器](#第8章-配接器)
    * [8.1 配接器的分类](#81-配接器的分类)
        * [8.1.2 迭代器配接器](#812-迭代器配接器)
        * [8.1.3 函数配接器](#813-函数配接器)
    * [8.3 迭代器配接器](#83-迭代器配接器)
        * [8.3.1 insert iterators](#831-insert-iterators)
        * [8.3.2 reverse iterators](#832-reverse-iterators)
        * [8.3.3 stream iterators](#833-stream-iterators)
    * [8.4 function adapters](#84-function-adapters)
        * [8.4.1 对返回值进行逻辑否定 not1 not2](#841-对返回值进行逻辑否定-not1-not2)
        * [8.4.2 对参数进行绑定 bind1st bind2nd](#842-对参数进行绑定-bind1st-bind2nd)
        * [8.4.3 用于函数合成 compose1 compose2](#843-用于函数合成-compose1-compose2)
        * [8.4.4 用于函数指针 ptr_fun](#844-用于函数指针-ptr_fun)
        * [8.4.5 用于成员函数指针 mem_fun mem_fun_ref](#845-用于成员函数指针-mem_fun-mem_fun_ref)
<!-- GFM-TOC -->
